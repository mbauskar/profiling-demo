"""
Django settings for profiling_demo project.
...
SECRET_KEY = 'django-insecure-n0^_pfm38q0#z#y^b6w6g@0-h=bd+6qj8y$6zt+j24x8vpyudb'
...
ROOT_URLCONF = 'profiling_demo.urls'
...
WSGI_APPLICATION = 'profiling_demo.wsgi.application'
...
SILKY_PYTHON_PROFILER_BINARY_DIR = str(BASE_DIR / "profiles")